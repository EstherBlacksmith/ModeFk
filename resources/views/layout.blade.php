  ...
  <body  style="background-color: WhiteSmoke;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-light " style="background-color: DarkSlateGray;">
...
<div class="container-fluid">
  <div id="encabezado " >  			  		
   <h3 style="color: DarkSlateGray;"><strong> @yield('tittle2')</strong></h3>
 </div>
</div>
